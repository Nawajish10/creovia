...
export function Footer() {
  ...
  return (
    <footer className="w-full flex flex-col mt-auto bg-surface-container-lowest text-on-surface">
      ...
      <section className="bg-surface py-12 px-margin-mobile md:px-margin-desktop border-t border-outline-variant/30">
        <div className="max-w-container-max mx-auto bg-gradient-to-br from-primary/10 via-background to-primary/5 rounded-[2rem] p-8 md:p-12 border border-outline-variant/30 relative overflow-hidden shadow-sm">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
            <div className="max-w-2xl space-y-3">
              <h2 className="font-headline-xl text-headline-xl text-text-primary tracking-tight leading-tight">
            ...
            <div className="flex flex-col sm:flex-row gap-4 shrink-0 w-full lg:w-auto">
              <Link href="/valuation" className="bg-primary text-on-primary px-8 py-4 rounded-xl font-label-md text-label-md hover:opacity-95 text-center transition-all shadow-md shadow-primary/20 active:scale-98">
                Get Free Valuation
              </Link>
              <Link href="/sell" className="bg-white text-text-primary border border-outline-variant/30 px-8 py-4 rounded-xl font-label-md text-label-md hover:bg-surface-container-low text-center transition-all active:scale-98">
                Sell Your Asset
              </Link>
            </div>
          </div>
      ...
      <section className="bg-surface-container-low/30 border-t border-outline-variant/30 py-8 px-margin-mobile md:px-margin-desktop">
        <div className="max-w-container-max mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={idx} className="flex gap-4 p-4 bg-white rounded-2xl border border-outline-variant/20 shadow-sm hover:shadow-md transition-shadow">
      ...
      <div className="border-t border-outline-variant/30 py-16 px-margin-mobile md:px-margin-desktop bg-surface-container-lowest">
        <div className="max-w-container-max mx-auto">
          {/* SECTION 4: NEWSLETTER SIGNUP */}
          <div className="border-b border-outline-variant/20 pb-12 mb-12 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 mb-12">
            ...
            <div className="lg:col-span-4 flex flex-col gap-4">
              <div className="flex flex-col">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-headline-lg text-text-primary tracking-tight font-bold text-[22px]">Axcrivo</span>
                </div>
            ...
            <nav className="lg:col-span-2 flex flex-col gap-4">
              <h4 className="font-label-md text-label-md font-bold text-on-surface uppercase tracking-widest text-[12px]">Marketplace</h4>
              <ul className="flex flex-col gap-2.5">
                <li><Link href="/buy" className="text-on-surface-variant font-body-md hover:text-primary transition-colors py-1 block">Buy Assets</Link></li>
                <li><Link href="/sell" className="text-on-surface-variant font-body-md hover:text-primary transition-colors py-1 block">Sell Assets</Link></li>
                <li><Link href="/valuation" className="text-on-surface-variant font-body-md hover:text-primary transition-colors py-1 block">Get Valuation</Link></li>
                <li><Link href="/buy" className="text-on-surface-variant font-body-md hover:text-primary transition-colors py-1 block">Marketplace</Link></li>
                <li><Link href="/#how-it-works" className="text-on-surface-variant font-body-md hover:text-primary transition-colors py-1 block">How It Works</Link></li>
              </ul>
            </nav>

            {/* COLUMN 3: Resources */}
            <nav className="lg:col-span-3 flex flex-col gap-4">
              <h4 className="font-label-md text-label-md font-bold text-on-surface uppercase tracking-widest text-[12px]">Resources</h4>
              <ul className="flex flex-col gap-2.5">
                <li><Link href="/resources" className="text-on-surface-variant font-body-md hover:text-primary transition-colors py-1 block">Valuation Guides</Link></li>
                <li><Link href="/resources" className="text-on-surface-variant font-body-md hover:text-primary transition-colors py-1 block">Buying Guides</Link></li>
                <li><Link href="/resources" className="text-on-surface-variant font-body-md hover:text-primary transition-colors py-1 block">Selling Guides</Link></li>
                <li><Link href="/resources" className="text-on-surface-variant font-body-md hover:text-primary transition-colors py-1 block">Creator Economy Insights</Link></li>
                <li><Link href="/resources" className="text-on-surface-variant font-body-md hover:text-primary transition-colors py-1 block">News</Link></li>
              </ul>
            </nav>

            {/* COLUMN 4: Company */}
            <nav className="lg:col-span-3 flex flex-col gap-4">
              <h4 className="font-label-md text-label-md font-bold text-on-surface uppercase tracking-widest text-[12px]">Company</h4>
              <ul className="flex flex-col gap-2.5">
                <li><Link href="/about" className="text-on-surface-variant font-body-md hover:text-primary transition-colors py-1 block">About Us</Link></li>
                <li><a href="mailto:support@axcrivo.in" className="text-on-surface-variant font-body-md hover:text-primary transition-colors py-1 block">Contact</a></li>
          ...
          <div className="border-t border-outline-variant/10 pt-8 pb-4 mb-8">
            <h4 className="font-label-md text-label-md font-bold text-on-surface uppercase tracking-widest text-[12px] mb-4">Supported Creator Assets</h4>
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <span
                  key={idx}
                  className="bg-surface-container-high text-on-surface-variant text-xs font-semibold px-3.5 py-1.5 rounded-full border border-outline-variant/30 hover:border-primary/30 transition-colors"
                >
                  {asset}
                </span>
              ))}
