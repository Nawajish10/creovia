          ...
          {isSuccess ? (
            ...
            <>
              <div className="text-center mb-10 relative z-10">
                <h2 className="font-headline-xl text-on-surface font-bold tracking-tight mb-3">Tell Us What You're Looking For</h2>
                <p className="font-body-lg text-on-surface-variant max-w-2xl mx-auto">Our concierges will match you with exclusive off-market listings that fit your exact acquisition criteria.</p>
              </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 relative z-10">
                ...
                <div className="space-y-5">
                  <h3 className="font-label-lg text-on-surface font-bold border-b border-outline-variant/30 pb-2">1. Your Details</h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    ...
                    <div className="space-y-1.5 group">
                      <label className="font-label-md text-on-surface-variant block transition-colors group-focus-within:text-primary">Work Email *</label>
                ...
                <div className="space-y-5">
                  <h3 className="font-label-lg text-on-surface font-bold border-b border-outline-variant/30 pb-2">2. Acquisition Criteria</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div className="space-y-1.5 group">
                      <label className="font-label-md text-on-surface-variant block transition-colors group-focus-within:text-primary">Budget Range *</label>
                    ...
                    <div className="space-y-1.5 group">
                      <label className="font-label-md text-on-surface-variant block transition-colors group-focus-within:text-primary">Primary Category *</label>
                      <div className="relative">
                    ...
                    <div className="space-y-1.5 group">
                      <label className="font-label-md text-on-surface-variant block transition-colors group-focus-within:text-primary">Preferred Niche</label>
                      <input {...register("niche")} className={inputClasses} placeholder="e.g. Finance, Tech, Entertainment" type="text" />
                    </div>

                    <div className="space-y-1.5 group">
                      <label className="font-label-md text-on-surface-variant block transition-colors group-focus-within:text-primary">Target Audience Location</label>
