...
export function Mission() {
  return (
    <SectionWrapper id="mission" className="py-12">
      {/* Hero Section */}
      <section className="relative pt-16 pb-12 px-margin-mobile md:px-margin-desktop max-w-7xl mx-auto w-full flex flex-col items-center text-center">
      ...
      {/* Mission Section */}
      <section className="py-12 px-margin-mobile md:px-margin-desktop max-w-7xl mx-auto w-full border-t border-outline-variant">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-gutter items-center">
          ...
          <div className="glass-panel rounded-xl p-8 aspect-video flex items-center justify-center glow-accent relative overflow-hidden">
            ...
            <span className="material-symbols-outlined text-6xl text-primary z-10" style={{ fontVariationSettings: "'FILL' 1" }}>account_balance</span>
          </div>
        </div>
      </section>
    </SectionWrapper>
