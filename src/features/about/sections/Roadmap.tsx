...
export function Roadmap() {
  return (
    <SectionWrapper id="roadmap" className="py-12">
      {/* Founder Story */}
      <section className="py-12 px-margin-mobile md:px-margin-desktop bg-surface-container-low w-full">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-gutter">
          <div className="md:col-span-5 h-[400px] md:h-auto glass-panel rounded-xl overflow-hidden relative">
          ...
          <div className="md:col-span-7 flex flex-col justify-center space-y-6 md:pl-12 py-8">
            <span className="font-label-md text-label-md text-primary uppercase tracking-widest">Why We Started</span>
