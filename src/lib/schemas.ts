...
export const sellerSchema = z.object({
  ...
  analytics_image_path: z.string().min(1, "Analytics screenshot is required"),
  analytics_signed_url: z.string().optional(),
  analytics_file_name: z.string().optional(),
  analytics_file_size: z.coerce.number().optional(),
